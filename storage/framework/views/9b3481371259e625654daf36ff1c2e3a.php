    ...
    <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10 lg:py-12">
        <div class="grid grid-cols-1 gap-8 md:grid-cols-12 items-start">
            <div class="md:col-span-5 flex items-start gap-4">
                <img src="<?php echo e(asset('images/logo-bimbel-removebg.png')); ?>" alt="Logo Pelita Ilmu" class="h-16 w-16 shrink-0 object-contain drop-shadow" onerror="this.src='<?php echo e(asset('images/logo-bimbel.png')); ?>'">
                <div class="space-y-1">
...
</footer><?php /**PATH C:\Users\DELL\Downloads\Kuliah\Projek-Bimbel\pelita-ilmu\resources\views/partials/footer.blade.php ENDPATH**/ ?>
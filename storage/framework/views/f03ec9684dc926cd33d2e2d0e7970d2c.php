...
<header class="fixed top-0 left-0 right-0 z-50 h-20 bg-white border-b border-stone-200 shadow-sm">
    <nav class="mx-auto flex h-full max-w-6xl items-center justify-between gap-4 px-4 sm:px-6" aria-label="Navigasi utama">
        ...
        <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 shrink-0">
            <img src="<?php echo e(asset('images/logo-bimbel-removebg.png')); ?>" alt="Logo Pelita Ilmu" class="h-14 w-14 object-contain" onerror="this.src='<?php echo e(asset('images/logo-bimbel.png')); ?>'">
        ...
        <div class="hidden lg:flex lg:items-center lg:gap-6 font-subtitle text-sm">
            <a href="<?php echo e(route('home')); ?>" class="px-3 py-2 text-void hover:text-primary font-bold transition-colors">Beranda</a>
            <a href="<?php echo e(route('home')); ?>#program" class="px-3 py-2 text-void hover:text-primary font-bold transition-colors">Program</a>
            <a href="<?php echo e(route('pendaftaran')); ?>" class="px-3 py-2 text-void hover:text-primary font-bold transition-colors">Pendaftaran</a>
            <a href="<?php echo e(route('home')); ?>#kontak" class="px-3 py-2 text-void hover:text-primary font-bold transition-colors">Kontak</a>

            <!-- Anti-Metal CTA Button — hanya muncul setelah scroll melewati hero CTA -->
            <a id="navbar-cta" href="<?php echo e(route('pendaftaran')); ?>" class="group/btn relative inline-flex h-11 min-w-[160px] items-center justify-center overflow-hidden rounded-xl bg-primary active:scale-[0.98] shadow-md whitespace-nowrap">
...
<div id="nav-menu" class="fixed bottom-6 left-1/2 -translate-x-1/2 z-[100] lg:hidden hidden">
    <div class="bg-[#193836] text-white rounded-3xl p-6 shadow-2xl border-2 border-highlight w-72 flex flex-col gap-4 text-center">
        ...
        <a href="<?php echo e(route('home')); ?>" onclick="toggleMobileMenu()" class="text-base font-headline font-extrabold text-white hover:text-highlight transition-colors">Beranda</a>
        <a href="<?php echo e(route('home')); ?>#program" onclick="toggleMobileMenu()" class="text-base font-headline font-extrabold text-white hover:text-highlight transition-colors">Program</a>
        <a href="<?php echo e(route('pendaftaran')); ?>" onclick="toggleMobileMenu()" class="text-base font-headline font-extrabold text-highlight">Pendaftaran</a>
        <a href="<?php echo e(route('home')); ?>#kontak" onclick="toggleMobileMenu()" class="text-base font-headline font-extrabold text-white hover:text-highlight transition-colors">Kontak</a>
...
<?php /**PATH C:\Users\DELL\Downloads\Kuliah\Projek-Bimbel\pelita-ilmu\resources\views/partials/navbar.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <style>
        ...
        /* Font alias classes — matching deployed naming */
        .font-headline { font-family: 'Quicksand', sans-serif; }
...
<body class="bg-canvas text-void min-h-screen flex flex-col antialiased selection:bg-primary selection:text-white">
    ...
    <header class="fixed top-0 left-0 right-0 z-50 h-20 bg-white border-b border-stone-200 shadow-sm">
        <nav class="mx-auto flex h-full max-w-6xl items-center justify-between gap-4 px-4 sm:px-6" aria-label="Navigasi utama">
            ...
            <div class="hidden lg:flex lg:items-center lg:gap-6 font-subtitle text-sm">
                <a href="#beranda" class="px-3 py-2 text-primary font-bold border-b-2 border-primary">Beranda</a>
                <a href="#program" class="px-3 py-2 text-void hover:text-primary font-bold transition-colors">Program</a>
                <a href="#daftar" class="px-3 py-2 text-void hover:text-primary font-bold transition-colors">Pendaftaran</a>
                <a href="#kontak" class="px-3 py-2 text-void hover:text-primary font-bold transition-colors">Kontak</a>

                <!-- Anti-Metal CTA Button — hanya muncul setelah scroll melewati hero CTA -->
                <a id="navbar-cta" href="{{ route('daftar') }}" class="group/btn relative inline-flex h-11 min-w-[160px] items-center justify-center overflow-hidden rounded-xl bg-primary active:scale-[0.98] shadow-md whitespace-nowrap">
    ...
    <div id="nav-menu" class="fixed bottom-6 left-1/2 -translate-x-1/2 z-[100] lg:hidden hidden">
        <div class="bg-[#193836] text-white rounded-3xl p-6 shadow-2xl border-2 border-highlight w-72 flex flex-col gap-4 text-center">
            ...
            <a href="#beranda" onclick="toggleMobileMenu()" class="text-base font-headline font-extrabold text-white hover:text-highlight transition-colors">Beranda</a>
            <a href="#program" onclick="toggleMobileMenu()" class="text-base font-headline font-extrabold text-white hover:text-highlight transition-colors">Program</a>
            <a href="#daftar" onclick="toggleMobileMenu()" class="text-base font-headline font-extrabold text-highlight">Pendaftaran</a>
            <a href="#kontak" onclick="toggleMobileMenu()" class="text-base font-headline font-extrabold text-white hover:text-highlight transition-colors">Kontak</a>
            <button onclick="toggleMobileMenu()" class="mt-2 py-2.5 px-4 bg-highlight text-void font-headline font-black rounded-xl text-xs uppercase tracking-wider shadow-sm hover:bg-yellow-400 transition-all">
                Tutup Menu
            </button>
        </div>
    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                    ...
                    <div class="order-1 lg:order-2 text-center lg:col-span-6 px-2">
                        ...
                        <div class="mt-8 flex justify-center">
                            <a id="hero-cta" href="{{ route('daftar') }}" class="group/btn relative inline-flex h-14 min-w-[280px] items-center justify-center overflow-hidden rounded-2xl bg-highlight shadow-xl active:scale-95 transition-all border-2 border-black">
            ...
            <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
                    ...
                    <div class="bg-white rounded-[32px] border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden flex flex-col justify-between">
                        ...
                        <div class="p-6 pt-0">
                            <a href="{{ route('daftar') }}" class="w-full inline-flex items-center justify-center gap-2 py-3.5 px-4 bg-highlight hover:bg-yellow-400 text-void font-headline font-extrabold text-xs uppercase tracking-wider rounded-xl border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none transition-all text-center">
                                PILIH PAKET TK &rarr;
                            </a>
                        </div>
                    </div>
                ...
                <div class="relative bg-[#193836] text-white rounded-[32px] p-8 sm:p-12 lg:p-16 overflow-hidden border-2 border-black shadow-2xl">
                    ...
                    <div class="relative z-10 max-w-3xl space-y-6">
                        ...
                        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-4">
                            ...
                            <a href="{{ route('daftar') }}" class="group/btn relative inline-flex h-14 items-center justify-center overflow-hidden rounded-full bg-highlight active:scale-95 transition-all border-2 border-black shadow-md px-8">
    ...
    <!-- FOOTER -->
    <footer id="kontak" class="bg-primary text-white border-t border-white/15">
        <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
            <div class="grid grid-cols-1 gap-10 md:grid-cols-12 lg:gap-12 items-start">
                ...
                <div class="md:col-span-5 flex items-start gap-4 sm:gap-5">
                    <img src="{{ asset('images/logo-bimbel-removebg.png') }}" alt="Logo Pelita Ilmu" class="h-20 w-20 sm:h-24 sm:w-24 shrink-0 object-contain" onerror="this.src='{{ asset('images/logo-bimbel.png') }}'">
                    <div class="space-y-2">
                        <h2 class="font-headline text-xl sm:text-2xl text-white font-bold">Pelita Ilmu</h2>
                        <p class="font-subtitle text-xs text-highlight font-bold tracking-wide uppercase">Bimbingan Belajar</p>
                        <p class="font-body text-sm text-white/85 leading-relaxed max-w-sm">
                            <a href="https://maps.app.goo.gl/4mZR8LgBXbN69YL4A" target="_blank" rel="noopener noreferrer" class="hover:text-highlight transition-colors inline-flex items-center gap-2">
                ...
                <div class="md:col-span-4 space-y-3">
                    <h3 class="font-subtitle text-base sm:text-lg font-bold text-white">Hubungi Kami</h3>
                    <ul class="space-y-2.5 font-body text-sm text-white/85">
                        <li>
                        ...
                        <li>
                            <a href="https://wa.me/6285866455553" target="_blank" rel="noopener noreferrer" class="hover:text-highlight transition-colors inline-flex items-center gap-2">
                                ...
                                <span class="text-white/70 text-xs">(Lita)</span>
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="md:col-span-3 space-y-3">
                    <h3 class="font-subtitle text-base sm:text-lg font-bold text-white">Media Sosial</h3>
                    <ul class="space-y-2.5 font-body text-sm text-white/85">
                        <li>
                            <a href="https://www.instagram.com/bimbelpelitailmu" target="_blank" rel="noopener noreferrer" class="hover:text-highlight transition-colors inline-flex items-center gap-2">
                                <span>Instagram</span>
                                <span class="text-white/70 text-xs">@bimbelpelitailmu</span>
                            </a>
                        </li>
                        <li>
        ...
        <div class="border-t border-white/15">
            <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-5 text-center text-xs text-white/75 font-body">
                &copy; {{ date('Y') }}
    ...
    <div id="easter-egg-modal" class="fixed inset-0 z-[120] hidden flex items-center justify-center bg-black/70 backdrop-blur-md p-4">
        <div class="relative w-full max-w-md bg-[#193836] border-4 border-highlight rounded-3xl p-6 sm:p-8 text-white shadow-2xl text-center overflow-hidden">
            <div class="absolute -top-10 -left-10 w-36 h-36 bg-highlight/20 rounded-full blur-2xl"></div>
            <div class="absolute -bottom-10 -right-10 w-36 h-36 bg-primary/40 rounded-full blur-2xl"></div>
    ...
    <script>
        ...
        // Scroll-triggered Navbar CTA:
        // Muncul smooth saat hero CTA (#hero-cta) sudah tidak terlihat di viewport
        (function() {
            ...
            const observer = new IntersectionObserver(
                ([entry]) => {
                    if (entry.isIntersecting) {
                        // Hero CTA masih terlihat → sembunyikan navbar CTA
                        navbarCta.classList.remove('cta-visible');
                    } else {
                        // Hero CTA sudah tidak terlihat → tampilkan navbar CTA
                ...
                },
                {
                    root: null,
                    threshold: 0,
                    rootMargin: '0px 0px -80px 0px' // offset sedikit agar transisi lebih natural
                }
            );
